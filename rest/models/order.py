...
class Order(models.Model):
    ...
    consignor = models.ForeignKey('Person', on_delete=models.SET_DEFAULT,related_name='consignor',default=1)
    consignee = models.ForeignKey('Person', on_delete=models.SET_DEFAULT,related_name='consignee',default=1)

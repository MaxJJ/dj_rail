...
class Factura(models.Model):
    ...
    buyer=models.ForeignKey(Person,related_name='factura_buyer',on_delete=models.CASCADE,null=True)
    seller=models.ForeignKey(Person,related_name='factura_seller',on_delete=models.CASCADE,null=True)
    consignee=models.ForeignKey(Person,related_name='factura_consignee',on_delete=models.CASCADE,null=True)
    consignor=models.ForeignKey(Person,related_name='factura_consignor',on_delete=models.CASCADE,null=True)
    ...
    cargo=models.ForeignKey(Cargo,related_name='factura_cargo',on_delete=models.CASCADE,null=True)
